...
const AgendaSection = () => {
  const sessions = [
    ...
    { time: "10:45 AM – 11:45 AM", title: "Live Design Challenge: AI in Action", facilitator: "3–5 designers", desc: "Designers tackle surprise prompt live using AI tools; audience Q&A and voting" },
    { time: "11:45 AM – 12:45 PM", title: "Why Executives Don't Care About Your Design Work (And How to Fix It)", facilitator: "Alexis Brochu", desc: "Your design is excellent. Your stakeholders are confused. Learn the \"So What?\" Chain—a questioning technique that reveals whether your work truly connects to business outcomes or just stops at user satisfaction. Through hands-on practice, you'll learn to answer the question every executive is silently asking: \"Why should I fund this?\"" },
    { time: "12:45 PM – 1:30 PM", title: "Lunch & Community Gallery Tour", facilitator: "Open/Self-Guided", desc: "45-min lunch + gallery walk exploring attendee artifacts" },
    { time: "1:30 PM – 2:30 PM", title: "Learning to Learn with AI", facilitator: "Volkan Unsal", desc: "Skill-building: AI research and learning strategies" },
    { time: "2:30 PM – 3:30 PM", title: "Community AMA & Teach-Back Collaborative Challenge", facilitator: "Suyen Stevenson", desc: "Collaborative Q&A and teach-back challenge where attendees apply new research/action skills and teach back what they've learned using AI tools" },
    { time: "3:30 PM – 4:30 PM", title: "AI Learning & Development Roadmap", facilitator: "Renata Rocha", desc: "Reflective: Build a 6-month personal L&D/action plan with AI" },
    ...
    { time: "5:00 PM", title: "AI-Powered Networking Finale", facilitator: "Suyen Stevenson", desc: "Matchmaking based on artifacts, interests, questions" },
